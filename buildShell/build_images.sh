...
do
		...
		[ -f /root/gitfile/cjxProject/$1/src/main/docker/$1.jar ] && mv -f /root/gitfile/cjxProject/$1/src/main/docker/$1.jar /root/jar/ || echo warning:no old file
		
		echo =====new jar go ot /root/gitfile/cjxProject/$i/src/main/docker/=====
